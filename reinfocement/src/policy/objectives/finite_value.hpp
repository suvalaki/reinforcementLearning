 ...
 */
template <environment::FiniteEnvironmentType E> struct FiniteValue : Value<E> {
...
concept isFiniteValueTemplate = std::is_base_of_v<FiniteValue<environment::dummy::DummyFiniteEnvironment>,
