...
class NormalMultiArmedBanditWrapper
    : public NormalPriorNormalMultiArmedBandit<double> {
public:
  PyObject_HEAD NormalMultiArmedBanditWrapper() = default;
};
 ...
 */
static PyObject *bandit_multi_armed_bandit(PyObject *self, PyObject *args) {
  const char *command;
  ...
  run_bandits(static_cast<std::size_t>(n_bandits),
...
static struct PyModuleDef banditmodule = {
    PyModuleDef_HEAD_INIT, "bandit", /* name of module */
    NULL,                            /* module documentation, may be NULL */
    -1, /* size of per-interpreter state of the module,
           or -1 if the module keeps state in global variables. */
    BanditMethods};

PyMODINIT_FUNC PyInit_bandit(void) { return PyModule_Create(&banditmodule); }
