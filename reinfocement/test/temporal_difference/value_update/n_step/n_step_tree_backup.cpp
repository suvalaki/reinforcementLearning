...
#include "temporal_difference/value_update/n_step/n_step_sarsa.hpp"
#include "temporal_difference/value_update/n_step/n_step_tree_backup.hpp"

using namespace temporal_difference;

TEST_CASE("temporal_difference::NStepNTreeBackup") {
  ...
  auto updater = NStepTreeSarsaUpdater<std::decay_t<decltype(valueFunction)>>(10);
