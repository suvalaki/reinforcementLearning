...
#include <reinforce/temporal_difference/value_update/expected_sarsa.hpp>
...
TEST_CASE("temporal_difference::ExpectedSARSAUpdater") {
  ...
  auto updater = ExpectedSARSAUpdater<std::decay_t<decltype(valueFunction)>>();
